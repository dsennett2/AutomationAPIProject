...
namespace AutomationAPI
{
	...
	public:
		...
		ExtendedFeatureCollection* ExtendedFeatures();
		...
		ExtendedFeatureCollection* m_extendedFeatureCollection;
...
AutomationAPI::ExtendedFeatureCollection* AutomationAPI::PartImpl::ExtendedFeatures()
{
	return m_extendedFeatureCollection;
}
...
AutomationAPI::ExtendedFeatureCollection* AutomationAPI::Part::ExtendedFeatures()
{
	return m_partImpl->ExtendedFeatures();
}
